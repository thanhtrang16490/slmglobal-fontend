...
const HeaderProductCatogeries = ({ hpcbackground = '', hpctitle, hpcsubtitle, data }: HeaderProductCatogeriesProps) => {
    ...
    return (
        <Content style={{ width: '100%', position: 'relative', height: '550px', marginTop: '50px' }}>
            ...
            <Content style={{ height: '190px', width: '1440px', maxWidth: '1440px', background: 'white', borderRadius: '8px', position: 'absolute', top: '180px', left: '50%', translate: '-50% -50px', boxShadow: '0 0 12px 0 rgba(0,0,0,.2)' }}>
            ...
            <Content style={{ height: '200px', width: '1200%', maxWidth: '1440px', background: 'white', borderRadius: '8px', position: 'absolute', top: '400px', left: '50%', translate: '-50% -50px', boxShadow: '0 0 12px 0 rgba(0,0,0,.2)' }}>
                <div >
